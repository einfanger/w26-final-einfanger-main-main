...
**Tasks:**
- Design a `Playlist` class that uses a linked list.
- You may use the built-in class or create your own
...
- You may need to use both or multiple to implement the full playlist
